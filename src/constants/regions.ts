// tạo list provinces (liệt kê) các tỉnh thành phố trong Việt Nam
...
// tạo list quốc gia trên thế giới (liên quan về du lịch)
export const countries = [
  ...
  { id: 8, name: 'Hàn Quốc' },
  { id: 9, name: 'Trung Quốc' },
  { id: 10, name: 'Đài Loan' },
  { id: 11, name: 'Hong Kong' },
  { id: 12, name: 'Ấn Độ' },
  { id: 13, name: 'Maldives' },
  { id: 14, name: 'Dubai' },
  { id: 15, name: 'Úc' },
  ...
  { id: 21, name: 'Đức' },
  { id: 22, name: 'Ý' },
  { id: 23, name: 'Tây Ban Nha' },
  { id: 24, name: 'Bồ Đào Nha' },
  { id: 25, name: 'Hà Lan' },
  { id: 26, name: 'Bỉ' },
  { id: 27, name: 'Thụy Sĩ' },
  { id: 28, name: 'Thụy Điển' },
  { id: 29, name: 'Na Uy' },
  { id: 30, name: 'Đan Mạch' }
];
